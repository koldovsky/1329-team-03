function initializeSlider() {
  ...
  // Робимо всі слайди видимими (fade-in)
  ...
  // При зміні розміру вікна перераховуємо ширину слайда
...
// Якщо використовуєте HTMX, можна ініціалізувати повторно після завантаження контенту
